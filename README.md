...
1. Install Python 
    ...
    1. Yollow this [guide](https://docs.python.org/3/using/windows.html) with the following steps
        ...
        3. Right clic on your Python directory, go to property/security, and check that you have (at least in admin) writing and modification right to be sure that new packages will be intalled in ./Lib/site-packages
...
2. Install Graphviz
    ...
    2. Make sure you have gcc installed, else you install it [here](https://visualstudio.microsoft.com/fr/visual-cpp-build-tools/) *(note: if you have MinGW or visual studio installed on your computer, you should already have a C/C++ compiler)*
...
4. Install LNetReduce
    ...
    1. Download the zip file and extract him where you want.
